...
& "$env:LOCALAPPDATA\Programs\draw.io\draw.io.exe" -x -f png --scale 2 -o ./diagrams/<name>.png ./diagrams/<name>.drawio
```
...
# --- Linux ---
# SVG
xvfb-run -a drawio -x -f svg -o ./diagrams/<name>.svg ./diagrams/<name>.drawio

# PDF
xvfb-run -a drawio -x -f pdf -o ./diagrams/<name>.pdf ./diagrams/<name>.drawio

# --- Windows ---
# SVG
& "$env:LOCALAPPDATA\Programs\draw.io\draw.io.exe" -x -f svg -o ./diagrams/<name>.svg ./diagrams/<name>.drawio

# PDF
& "$env:LOCALAPPDATA\Programs\draw.io\draw.io.exe" -x -f pdf -o ./diagrams/<name>.pdf ./diagrams/<name>.drawio

# High-res PNG (scale 3)
& "$env:LOCALAPPDATA\Programs\draw.io\draw.io.exe" -x -f png --scale 3 -o ./diagrams/<name>_hd.png ./diagrams/<name>.drawio

# Transparent background
& "$env:LOCALAPPDATA\Programs\draw.io\draw.io.exe" -x -f png -t --scale 2 -o ./diagrams/<name>_transparent.png ./diagrams/<name>.drawio
```

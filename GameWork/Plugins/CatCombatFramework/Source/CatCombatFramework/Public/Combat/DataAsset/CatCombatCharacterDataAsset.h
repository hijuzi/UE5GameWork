...
#include "CatCombatCharacterDataAsset.generated.h"
 ...
 */
UCLASS()
class CATCOMBATFRAMEWORK_API UCatCombatCharacterDataAsset : public UDataAsset
{
	GENERATED_BODY()
...
public:
	...
	/** 该角色使用的能力列表（生成后授予到角色 ASC；若角色实现 ICatCombatAbilityGranter，则改由其自行授予） */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "CombatCharacter")

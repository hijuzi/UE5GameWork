...
#include "CatCombatRoundTimer.generated.h"
 ...
 * 由 UCatCombatManagerSubsystem 决定如何处理（如 StopCurrentTask）。
 * Tick 生命周期跟随战斗开始/结束，而非 Subsystem 生命周期。
 */
UCLASS()
class CATCOMBATFRAMEWORK_API UCatCombatRoundTimer : public UObject
{
	GENERATED_BODY()
...
private:
	...
	/** 单回合最大时长（秒，缓存自 UCatCombatSettings，避免每帧查询 CDO） */

...
#include "CatCombatHUDHandler.generated.h"
...
struct FCatCombatHUDVisibilityParams
{
	GENERATED_BODY()
 ...
 * 不负责决定"何时"显示/隐藏 —— 该决策由 UCatCombatManagerSubsystem 或外部调用方承担。
 *
...
class CATCOMBATFRAMEWORK_API UCatCombatHUDHandler : public UObject
{
	GENERATED_BODY()
...
public:
	...
	void SetVisible(bool bVisible, const FCatCombatHUDVisibilityParams& Params = FCatCombatHUDVisibilityParams()) const;
...
private:
	...
	UPROPERTY(Transient)
	TObjectPtr<UCatCombatHUDLayout> SpawnedHUD;

...
#include "CatCombatAbilityGranter.generated.h"
 ...
 * 战斗角色在生成后，由数据层 UCatCombatDataStore 调用此接口，将技能/属性集/效果
 * 授予到角色自身的 UAbilitySystemComponent。具体授予逻辑由角色类实现（C++ 或蓝图）。
 */
UINTERFACE(MinimalAPI, Blueprintable)
class UCatCombatAbilityGranter : public UInterface
{
	GENERATED_BODY()
};

class CATCOMBATFRAMEWORK_API ICatCombatAbilityGranter
{
	GENERATED_BODY()
